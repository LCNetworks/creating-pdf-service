package cn.com.tools.service.exception;
...
public class DocumentGeneratingException extends Exception {
    ...
    /**
     * Constructs an {@code DocumentGeneratingException} with {@code null} as
    ...
    /**
     * Constructs an {@code DocumentGeneratingException} with the specified
     * detail message.
     *
